...
@protocol PierPageTipoOrigemComercialResponse
@end

@interface PierPageTipoOrigemComercialResponse : PierObject


@property(nonatomic) NSArray<PierTipoOrigemComercialResponse>* content;
