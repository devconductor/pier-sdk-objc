...
@implementation PierTransacoesCorrentes
...
{
  return [[JSONKeyMapper alloc] initWithDictionary:@{ @"id": @"_id", @"tipoTransacao": @"tipoTransacao", @"statusTransacao": @"statusTransacao", @"idEvento": @"idEvento", @"tipoEvento": @"tipoEvento", @"idConta": @"idConta", @"cartaoMascarado": @"cartaoMascarado", @"nomePortador": @"nomePortador", @"dataTransacaoUTC": @"dataTransacaoUTC", @"dataFaturamento": @"dataFaturamento", @"dataVencimento": @"dataVencimento", @"modoEntradaTransacao": @"modoEntradaTransacao", @"valorTaxaEmbarque": @"valorTaxaEmbarque", @"valorEntrada": @"valorEntrada", @"valorBRL": @"valorBRL", @"valorUSD": @"valorUSD", @"cotacaoUSD": @"cotacaoUSD", @"dataCotacaoUSD": @"dataCotacaoUSD", @"codigoMoedaOrigem": @"codigoMoedaOrigem", @"codigoMoedaDestino": @"codigoMoedaDestino", @"codigoAutorizacao": @"codigoAutorizacao", @"codigoReferencia": @"codigoReferencia", @"codigoTerminal": @"codigoTerminal", @"codigoMCC": @"codigoMCC", @"idEstabelecimento": @"idEstabelecimento", @"nomeEstabelecimento": @"nomeEstabelecimento", @"localidadeEstabelecimento": @"localidadeEstabelecimento", @"planoParcelamento": @"planoParcelamento", @"numeroParcela": @"numeroParcela", @"detalhesTransacao": @"detalhesTransacao", @"flagCredito": @"flagCredito", @"flagFaturado": @"flagFaturado", @"flagEstorno": @"flagEstorno", @"idTransacaoEstorno": @"idTransacaoEstorno" }];
}
