...
{
  return [[JSONKeyMapper alloc] initWithDictionary:@{ @"idConta": @"idConta", @"idPessoa": @"idPessoa", @"idCartao": @"idCartao", @"idBandeira": @"idBandeira", @"idTipoCartao": @"idTipoCartao", @"numeroCartao": @"numeroCartao", @"nomePlastico": @"nomePlastico", @"cvv2": @"cvv2", @"dataGeracao": @"dataGeracao", @"dataValidade": @"dataValidade", @"nomeOrigemComercial": @"nomeOrigemComercial", @"nomeEmpresa": @"nomeEmpresa", @"numeroAgencia": @"numeroAgencia", @"numeroContaCorente": @"numeroContaCorente", @"nomeEmpresaBeneficio": @"nomeEmpresaBeneficio", @"cpf": @"cpf", @"tipoPortador": @"tipoPortador", @"nomeEmpregador": @"nomeEmpregador", @"trilha1": @"trilha1", @"trilha2": @"trilha2", @"trilhaCVV1": @"trilhaCVV1", @"trilhaCVV2": @"trilhaCVV2", @"flagVirtual": @"flagVirtual", @"numeroCartaoHash": @"numeroCartaoHash" }];
}
