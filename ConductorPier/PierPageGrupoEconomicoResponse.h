...
@protocol PierPageGrupoEconomicoResponse
@end

@interface PierPageGrupoEconomicoResponse : PierObject


@property(nonatomic) NSArray<PierGrupoEconomicoResponse>* content;
