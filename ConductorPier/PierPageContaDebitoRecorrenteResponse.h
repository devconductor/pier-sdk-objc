...
@protocol PierPageContaDebitoRecorrenteResponse
@end

@interface PierPageContaDebitoRecorrenteResponse : PierObject


@property(nonatomic) NSArray<PierContaDebitoRecorrenteResponse>* content;
