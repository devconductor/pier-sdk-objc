...
@protocol PierPageControleSegurancaDispositivoResponse
@end

@interface PierPageControleSegurancaDispositivoResponse : PierObject


@property(nonatomic) NSArray<PierControleSegurancaDispositivoResponse>* content;
