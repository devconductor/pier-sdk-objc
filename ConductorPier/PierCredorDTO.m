...
{
  NSArray *optionalProperties = @[@"nome", @"pagamentoSemanal", @"pagamentoMensal", @"pagamentoDecendialPrimeiro", @"pagamentoDecendialSegundo", @"pagamentoDecendialTerceiro", @"pagamentoQuinzenalPrimeiro", @"pagamentoQuinzenalSegundo", @"credorBanco", @"recebeRAV", @"percentualMultiplica", @"taxaAdm", @"taxaBanco", @"limiteRAV", @"idCredorRAV", @"banco", @"agencia", @"digitoVerificadorAgencia", @"contaCorrente", @"digitoVerificadorContaCorrente"];
