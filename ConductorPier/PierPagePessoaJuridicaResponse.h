...
@protocol PierPagePessoaJuridicaResponse
@end

@interface PierPagePessoaJuridicaResponse : PierObject


@property(nonatomic) NSArray<PierPessoaJuridicaResponse>* content;
