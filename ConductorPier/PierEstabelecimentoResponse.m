...
{
  return [[JSONKeyMapper alloc] initWithDictionary:@{ @"id": @"_id", @"numeroEstabelecimento": @"numeroEstabelecimento", @"flagMatriz": @"flagMatriz", @"idGrupoEconomico": @"idGrupoEconomico", @"numeroReceitaFederal": @"numeroReceitaFederal", @"nome": @"nome", @"descricao": @"descricao", @"nomeFantasia": @"nomeFantasia", @"cep": @"cep", @"nomeLogradouro": @"nomeLogradouro", @"numeroEndereco": @"numeroEndereco", @"bairro": @"bairro", @"cidade": @"cidade", @"complemento": @"complemento", @"uf": @"uf", @"cep2": @"cep2", @"nomeLogradouro2": @"nomeLogradouro2", @"numeroEndereco2": @"numeroEndereco2", @"bairro2": @"bairro2", @"cidade2": @"cidade2", @"complemento2": @"complemento2", @"uf2": @"uf2", @"obs": @"obs", @"contato": @"contato", @"email": @"email", @"flagArquivoSecrFazenda": @"flagArquivoSecrFazenda", @"flagCartaoDigitado": @"flagCartaoDigitado", @"inativo": @"inativo", @"idMoeda": @"idMoeda", @"idPais": @"idPais", @"associadoSPCBrasil": @"associadoSPCBrasil", @"mcc": @"mcc", @"idTipoEstabelecimento": @"idTipoEstabelecimento", @"correspondencia": @"correspondencia", @"cargoContato": @"cargoContato", @"tipoPagamento": @"tipoPagamento", @"consulta": @"consulta", @"consulta2": @"consulta2", @"consulta3": @"consulta3", @"terminal": @"terminal", @"dataCadastramento": @"dataCadastramento", @"usuario": @"usuario" }];
}
