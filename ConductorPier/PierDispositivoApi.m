...
@interface PierDispositivoApi ()
    @property (readwrite, nonatomic, strong) NSMutableDictionary *defaultHeaders;
@end

@implementation PierDispositivoApi

static PierDispositivoApi* singletonAPI = nil;
...
+(PierDispositivoApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    ...
    if (singletonAPI == nil) {
        singletonAPI = [[PierDispositivoApi alloc] init];
