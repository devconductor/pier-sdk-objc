...
@protocol PierPageAplicacaoMobileResponse
@end

@interface PierPageAplicacaoMobileResponse : PierObject


@property(nonatomic) NSArray<PierAplicacaoMobileResponse>* content;
