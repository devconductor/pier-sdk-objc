...
///
///  @param idTipoDebitoRecorrente C\u00F3digo de identifica\u00E7\u00E3o do tipo de d\u00E9bito recorrente (id) (optional)
///
...
///
///  @param dataHoraInicio Data inicio do d\u00E9bito recorrente. (optional)
///
///  @param dataHoraFim Data fim do d\u00E9bito recorrente. (optional)
///
///  @param ativo Identifica se o d\u00E9bito recorrente est\u00E1 ativo. (optional)
///
///  @param dataHoraUltimoPagamento Data do \u00FAltimo pagamento efetuado. (optional)
///
...
-(NSNumber*) listarUsingGET16WithIdConta: (NSNumber*) idConta
    ...
    if (idConta == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `idConta` when calling `listarUsingGET16`"];
    }
...
///  @param limit Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50) (optional)
///
///  @param _id C\u00F3digo de identifica\u00E7\u00E3o do tipo de d\u00E9bito recorrente (id). (optional)
///
///  @param descricao Descri\u00E7\u00E3o do tipo de d\u00E9bito recorrente. (optional)
///
///  @param valor Valor do tipo de d\u00E9bito recorrente. (optional)
///
///  @param flagAtivo Flag que identifica se o tipo d\u00E9bito recorrente est\u00E1 ativo. (optional)
///
///  @returns PierPageTipoDebitoRecorrenteResponse*
///
