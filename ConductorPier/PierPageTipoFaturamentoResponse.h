...
@protocol PierPageTipoFaturamentoResponse
@end

@interface PierPageTipoFaturamentoResponse : PierObject


@property(nonatomic) NSArray<PierTipoFaturamentoResponse>* content;
