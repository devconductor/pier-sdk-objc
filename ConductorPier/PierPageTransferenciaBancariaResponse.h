...
@protocol PierPageTransferenciaBancariaResponse
@end

@interface PierPageTransferenciaBancariaResponse : PierObject


@property(nonatomic) NSArray<PierTransferenciaBancariaResponse>* content;
