...
{
  NSArray *optionalProperties = @[@"idPessoa", @"nomeMae", @"idEstadoCivil", @"profissao", @"idNaturezaOcupacao", @"idNacionalidade", @"numeroAgencia", @"numeroContaCorrente", @"email", @"nomeEmpresa"];
