...
@protocol PierPageConfiguracaoRotativoResponse
@end

@interface PierPageConfiguracaoRotativoResponse : PierObject


@property(nonatomic) NSArray<PierConfiguracaoRotativoDetalheResponse>* content;
