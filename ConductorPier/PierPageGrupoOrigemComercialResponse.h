...
@protocol PierPageGrupoOrigemComercialResponse
@end

@interface PierPageGrupoOrigemComercialResponse : PierObject


@property(nonatomic) NSArray<PierGrupoOrigemComercialResponse>* content;
