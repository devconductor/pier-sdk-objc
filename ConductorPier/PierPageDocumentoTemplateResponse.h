...
@protocol PierPageDocumentoTemplateResponse
@end

@interface PierPageDocumentoTemplateResponse : PierObject


@property(nonatomic) NSArray<PierDocumentoTemplateResponse>* content;
