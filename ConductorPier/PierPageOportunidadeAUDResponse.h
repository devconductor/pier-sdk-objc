...
@protocol PierPageOportunidadeAUDResponse
@end

@interface PierPageOportunidadeAUDResponse : PierObject


@property(nonatomic) NSArray<PierOportunidadeAUDResponse>* content;
