...
@interface PierGlobaltagpayApi ()
    @property (readwrite, nonatomic, strong) NSMutableDictionary *defaultHeaders;
@end

@implementation PierGlobaltagpayApi

static PierGlobaltagpayApi* singletonAPI = nil;
...
+(PierGlobaltagpayApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    ...
    if (singletonAPI == nil) {
        singletonAPI = [[PierGlobaltagpayApi alloc] init];
...
///  @param deviceId {{{cartao_pay_resource_listar_param_device_id}}} (optional)
///
...
///
///  @param status {{{cartao_pay_request_status_value}}} (optional)
///
///  @param numeroCartao {{{cartao_pay_request_numero_cartao_value}}} (optional)
///
