...
@protocol PierPageTipoFaturamentoPorContaResponse
@end

@interface PierPageTipoFaturamentoPorContaResponse : PierObject


@property(nonatomic) NSArray<PierTipoFaturamentoPorContaResponse>* content;
