...
@protocol PierPageFaturaConsignadaResponse
@end

@interface PierPageFaturaConsignadaResponse : PierObject


@property(nonatomic) NSArray<PierFaturaConsignadaResponse>* content;
