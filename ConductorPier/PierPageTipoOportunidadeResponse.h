...
@protocol PierPageTipoOportunidadeResponse
@end

@interface PierPageTipoOportunidadeResponse : PierObject


@property(nonatomic) NSArray<PierTipoOportunidadeResponse>* content;
