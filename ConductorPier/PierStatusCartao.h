 ...
 */
@property(nonatomic) NSNumber* flagAlteraStatus;
 ...
 */
@property(nonatomic) NSNumber* flagCadastroNovaSenha;
 ...
 */
@property(nonatomic) NSNumber* flagCancelaConta;
 ...
 */
@property(nonatomic) NSNumber* flagDestinoTransferencia;
/* Quando ativa, indica que poder\u00C3\u00A1 ser criado um novo cart\u00C3\u00A3o provis\u00C3\u00B3rio para o portador. 
 */
@property(nonatomic) NSNumber* flagEmiteProvisorio;
 ...
 */
@property(nonatomic) NSNumber* flagExcecaoBandeira;
 ...
 */
@property(nonatomic) NSNumber* flagOrigemTransferencia;
 ...
 */
@property(nonatomic) NSNumber* flagReemiteCartao;
