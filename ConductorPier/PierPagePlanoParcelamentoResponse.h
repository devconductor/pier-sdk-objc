...
@protocol PierPagePlanoParcelamentoResponse
@end

@interface PierPagePlanoParcelamentoResponse : PierObject


@property(nonatomic) NSArray<PierPlanoParcelamentoResponse>* content;
