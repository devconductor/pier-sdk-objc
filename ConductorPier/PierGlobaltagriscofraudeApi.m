#import "PierGlobaltagriscofraudeApi.h"
...
@interface PierGlobaltagriscofraudeApi ()
    @property (readwrite, nonatomic, strong) NSMutableDictionary *defaultHeaders;
@end

@implementation PierGlobaltagriscofraudeApi

static PierGlobaltagriscofraudeApi* singletonAPI = nil;
...
+(PierGlobaltagriscofraudeApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    ...
    if (singletonAPI == nil) {
        singletonAPI = [[PierGlobaltagriscofraudeApi alloc] init];
...
-(NSNumber*) validarDadosPortadorUsingPOSTWithRequest: (PierDadosPortadorRequest*) request
    ...
    if (request == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `request` when calling `validarDadosPortadorUsingPOST`"];
    }
    

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/riscos-fraudes/validar-dados-portador"];
