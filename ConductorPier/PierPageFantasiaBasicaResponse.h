...
@protocol PierPageFantasiaBasicaResponse
@end

@interface PierPageFantasiaBasicaResponse : PierObject


@property(nonatomic) NSArray<PierFantasiaBasicaResponse>* content;
