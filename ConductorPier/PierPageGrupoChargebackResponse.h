...
@protocol PierPageGrupoChargebackResponse
@end

@interface PierPageGrupoChargebackResponse : PierObject


@property(nonatomic) NSArray<PierGrupoChargebackResponse>* content;
