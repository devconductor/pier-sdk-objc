...
-(NSNumber*) alterarUsingPUT12WithId: (NSNumber*) _id
    ...
    if (tipoEvento == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `tipoEvento` when calling `alterarUsingPUT12`"];
    }
    
    // verify the required parameter 'url' is set
    if (url == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `url` when calling `alterarUsingPUT12`"];
    }
...
-(NSNumber*) salvarUsingPOST21WithTipoEvento: (NSString*) tipoEvento
    ...
    // verify the required parameter 'tipoEvento' is set
    if (tipoEvento == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `tipoEvento` when calling `salvarUsingPOST21`"];
    }
    
    // verify the required parameter 'url' is set
    if (url == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `url` when calling `salvarUsingPOST21`"];
    }
