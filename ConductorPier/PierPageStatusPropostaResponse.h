...
@protocol PierPageStatusPropostaResponse
@end

@interface PierPageStatusPropostaResponse : PierObject


@property(nonatomic) NSArray<PierStatusPropostaResponse>* content;
