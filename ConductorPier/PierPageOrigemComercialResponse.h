...
@protocol PierPageOrigemComercialResponse
@end

@interface PierPageOrigemComercialResponse : PierObject


@property(nonatomic) NSArray<PierOrigemComercialResponse>* content;
