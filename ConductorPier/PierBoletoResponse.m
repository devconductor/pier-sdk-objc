...
{
  NSArray *optionalProperties = @[@"numeroDoDocumento", @"dataProcessamento", @"dataDocumento", @"dataVencimento", @"dataFechamento", @"valorBoleto", @"nomeBeneficiario", @"documentoBeneficiario", @"agencia", @"codigoBeneficiario", @"numeroConvenio", @"digitoCodigoBeneficiario", @"carteira", @"nossoNumero", @"digitoNossoNumero", @"banco", @"aceite", @"especieDoDocumento", @"especie", @"instrucoes", @"locaisDePagamento", @"nomePagador", @"documentoPagador", @"logradouroPagador", @"bairroPagador", @"cepPagador", @"cidadePagador", @"ufPagador", @"codigoDeBarras", @"linhaDigitavel", @"_id", @"idConta", @"enderecoCobrancaBeneficiario", @"status", @"boletoRegistrado"];
