...
@protocol PierConvenioResponse
@end

@interface PierConvenioResponse : PierObject

/* Id do conv\u00EAnio. [optional]
 */
@property(nonatomic) NSNumber* _id;
/* Identifica\u00E7\u00E3o do banco. [optional]
 */
 ...
 */
@property(nonatomic) NSString* aceite;
...
/* Usu\u00E1rio responsavel pelo cadastro e/ou altera\u00E7\u00E3o do conv\u00EAnio. [optional]
 */
@property(nonatomic) NSString* operador;
/* Data de cadastro/altera\u00E7\u00E3o do conv\u00EAnio. [optional]
 */
@property(nonatomic) NSString* data;
/* M\u00E1quina pela qual foi realizado o cadastro ou altera\u00E7\u00E3o. [optional]
 */
@property(nonatomic) NSString* maquina;
