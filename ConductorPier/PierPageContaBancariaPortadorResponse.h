...
@protocol PierPageContaBancariaPortadorResponse
@end

@interface PierPageContaBancariaPortadorResponse : PierObject


@property(nonatomic) NSArray<PierContaBancariaPortadorResponse>* content;
