#import "PierGlobaltagplataformamobileApi.h"
...
@interface PierGlobaltagplataformamobileApi ()
    @property (readwrite, nonatomic, strong) NSMutableDictionary *defaultHeaders;
@end

@implementation PierGlobaltagplataformamobileApi

static PierGlobaltagplataformamobileApi* singletonAPI = nil;
...
+(PierGlobaltagplataformamobileApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    ...
    if (singletonAPI == nil) {
        singletonAPI = [[PierGlobaltagplataformamobileApi alloc] init];
...
///
///  @param nome {{{plataforma_mobile_request_nome_value}}} (optional)
///
