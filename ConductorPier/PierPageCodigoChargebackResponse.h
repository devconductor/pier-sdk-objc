...
@protocol PierPageCodigoChargebackResponse
@end

@interface PierPageCodigoChargebackResponse : PierObject


@property(nonatomic) NSArray<PierCodigoChargebackResponse>* content;
