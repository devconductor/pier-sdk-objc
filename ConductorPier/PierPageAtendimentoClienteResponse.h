...
@protocol PierPageAtendimentoClienteResponse
@end

@interface PierPageAtendimentoClienteResponse : PierObject


@property(nonatomic) NSArray<PierAtendimentoClienteResponse>* content;
