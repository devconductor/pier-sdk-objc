...
@protocol PierPageTransacaoNaoProcessadaResponse
@end

@interface PierPageTransacaoNaoProcessadaResponse : PierObject


@property(nonatomic) NSArray<PierTransacaoNaoProcessadaResponse>* content;
