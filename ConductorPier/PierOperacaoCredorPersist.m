...
{
  NSArray *optionalProperties = @[@"remuneracaoPercentual", @"remuneracaoFixa", @"periodicidade", @"vencimentoPrimeiraParcela", @"diasAfastamento", @"fatorMultiplicador", @"flagTaxaFixada", ];
