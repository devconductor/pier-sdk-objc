...
@protocol PierPageContaHistoricoPagamentoResponse
@end

@interface PierPageContaHistoricoPagamentoResponse : PierObject


@property(nonatomic) NSArray<PierContaHistoricoPagamentoResponse>* content;
