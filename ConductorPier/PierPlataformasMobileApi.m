...
@interface PierPlataformasMobileApi ()
    @property (readwrite, nonatomic, strong) NSMutableDictionary *defaultHeaders;
@end

@implementation PierPlataformasMobileApi

static PierPlataformasMobileApi* singletonAPI = nil;
...
+(PierPlataformasMobileApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    ...
    if (singletonAPI == nil) {
        singletonAPI = [[PierPlataformasMobileApi alloc] init];
