...
@protocol PierPageTipoResolucaoContestacaoResponse
@end

@interface PierPageTipoResolucaoContestacaoResponse : PierObject


@property(nonatomic) NSArray<PierCdtTipoResolucaoContestacao>* content;
