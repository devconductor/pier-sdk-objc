...
@protocol PierPageTemplateNotificacaoResponse
@end

@interface PierPageTemplateNotificacaoResponse : PierObject


@property(nonatomic) NSArray<PierTemplateNotificacaoResponse>* content;
