...
@protocol PierPageDetalheAjusteLoteResponse
@end

@interface PierPageDetalheAjusteLoteResponse : PierObject


@property(nonatomic) NSArray<PierDetalheAjusteLoteResponse>* content;
