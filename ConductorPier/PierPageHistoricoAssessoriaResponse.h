...
@protocol PierPageHistoricoAssessoriaResponse
@end

@interface PierPageHistoricoAssessoriaResponse : PierObject


@property(nonatomic) NSArray<PierHistoricoAssessoriaResponse>* content;
