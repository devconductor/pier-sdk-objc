...
@implementation PierFaturaConsignadaResponse
...
{
  return [[JSONKeyMapper alloc] initWithDictionary:@{ @"id": @"_id", @"idConta": @"idConta", @"flagEmiteFatura": @"flagEmiteFatura", @"dataVencimentoFatura": @"dataVencimentoFatura", @"valorTotalFatura": @"valorTotalFatura", @"valorFaturaAnterior": @"valorFaturaAnterior", @"valorPagamentoMinimo": @"valorPagamentoMinimo", @"valorPagamentoConsignado": @"valorPagamentoConsignado", @"valorPagamentoComplementar": @"valorPagamentoComplementar", @"totalComprasNacionais": @"totalComprasNacionais", @"totalComprasInternacionas": @"totalComprasInternacionas", @"totalSaquesNacionais": @"totalSaquesNacionais", @"totalSaquesInternacionais": @"totalSaquesInternacionais", @"totalDebitosNacionais": @"totalDebitosNacionais", @"totalDebitosRecorrentes": @"totalDebitosRecorrentes", @"totalDebitosInternacionais": @"totalDebitosInternacionais", @"totalDebitosDiversosNacionais": @"totalDebitosDiversosNacionais", @"totalDebitosOpcionais": @"totalDebitosOpcionais", @"totalPagamentos": @"totalPagamentos", @"totalCreditosNacionais": @"totalCreditosNacionais", @"totalAjustes": @"totalAjustes", @"totalTarifas": @"totalTarifas", @"totalMulta": @"totalMulta", @"totalJuros": @"totalJuros", @"taxaRotativo": @"taxaRotativo", @"taxaSaque": @"taxaSaque", @"taxaMaximaProximoPeriodo": @"taxaMaximaProximoPeriodo", @"totalServicos": @"totalServicos" }];
}
