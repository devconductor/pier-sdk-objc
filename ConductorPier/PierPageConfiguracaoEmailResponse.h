...
@protocol PierPageConfiguracaoEmailResponse
@end

@interface PierPageConfiguracaoEmailResponse : PierObject


@property(nonatomic) NSArray<PierConfiguracaoEmailResponse>* content;
