...
@protocol PierPageHistoricoPagamentoResponse
@end

@interface PierPageHistoricoPagamentoResponse : PierObject


@property(nonatomic) NSArray<PierHistoricoPagamentoResponse>* content;
