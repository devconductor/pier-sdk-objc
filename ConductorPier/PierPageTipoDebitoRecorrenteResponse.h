...
@protocol PierPageTipoDebitoRecorrenteResponse
@end

@interface PierPageTipoDebitoRecorrenteResponse : PierObject


@property(nonatomic) NSArray<PierTipoDebitoRecorrenteResponse>* content;
