#import "PierServicosContaApi.h"
#import "PierQueryParamCollection.h"
#import "PierPageAnuidadeResponse.h"
#import "PierPageOperadoraResponse.h"


@interface PierServicosContaApi ()
    @property (readwrite, nonatomic, strong) NSMutableDictionary *defaultHeaders;
@end

@implementation PierServicosContaApi

static PierServicosContaApi* singletonAPI = nil;
...
+(PierServicosContaApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    ...
    if (singletonAPI == nil) {
        singletonAPI = [[PierServicosContaApi alloc] init];
