...
@protocol PierCartaoPayCadastroResponse
@end

@interface PierCartaoPayCadastroResponse : PierObject
...
/* {{{cartao_pay_cadastro_response_cvv_value}}} [optional]
 */
@property(nonatomic) NSString* cvv;
/* {{{cartao_pay_cadastro_response_chave_criptograma_value}}} [optional]
 */
