...
@protocol PierPageTransacaoProcessadaNaoProcessadaResponse
@end

@interface PierPageTransacaoProcessadaNaoProcessadaResponse : PierObject


@property(nonatomic) NSArray<PierTransacaoProcessadaNaoProcessadaResponse>* content;
