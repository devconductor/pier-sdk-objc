...
@protocol PierPageTransacoesCorrentesResponse
@end

@interface PierPageTransacoesCorrentesResponse : PierObject


@property(nonatomic) NSArray<PierTransacoesCorrentesResponse>* content;
