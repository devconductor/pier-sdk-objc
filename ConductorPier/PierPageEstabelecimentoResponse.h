...
@protocol PierPageEstabelecimentoResponse
@end

@interface PierPageEstabelecimentoResponse : PierObject


@property(nonatomic) NSArray<PierEstabelecimentoResponse>* content;
