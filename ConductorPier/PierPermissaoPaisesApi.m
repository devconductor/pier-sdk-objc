#import "PierPermissaoPaisesApi.h"
#import "PierQueryParamCollection.h"
#import "PierPaisResponse.h"
#import "PierPagePaisResponse.h"


@interface PierPermissaoPaisesApi ()
    @property (readwrite, nonatomic, strong) NSMutableDictionary *defaultHeaders;
@end

@implementation PierPermissaoPaisesApi

static PierPermissaoPaisesApi* singletonAPI = nil;
...
+(PierPermissaoPaisesApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    ...
    if (singletonAPI == nil) {
        singletonAPI = [[PierPermissaoPaisesApi alloc] init];
