...
@protocol PierPageCompraContestadaTransacaoResponse
@end

@interface PierPageCompraContestadaTransacaoResponse : PierObject


@property(nonatomic) NSArray<PierCompraContestadaTransacaoResponse>* content;
