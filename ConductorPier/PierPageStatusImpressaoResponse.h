...
@protocol PierPageStatusImpressaoResponse
@end

@interface PierPageStatusImpressaoResponse : PierObject


@property(nonatomic) NSArray<PierStatusImpressaoResponse>* content;
