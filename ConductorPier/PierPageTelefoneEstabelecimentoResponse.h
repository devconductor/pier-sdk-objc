...
@protocol PierPageTelefoneEstabelecimentoResponse
@end

@interface PierPageTelefoneEstabelecimentoResponse : PierObject


@property(nonatomic) NSArray<PierTelefoneEstabelecimentoResponse>* content;
