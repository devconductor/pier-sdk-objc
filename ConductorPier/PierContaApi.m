...
///
///  @param idEscritorioCobranca C\u00F3digo de identifica\u00E7\u00E3o do escrit\u00F3rio de cobran\u00E7a (optional)
///
...
-(NSNumber*) consultarUsingGET42WithId: (NSNumber*) _id
    ...
    if (idTransferencia == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `idTransferencia` when calling `consultarUsingGET42`"];
    }
...
///
///  @param idTipoPlastico C\u00F3digo de identifica\u00E7\u00E3o do TipoPlastico (id). (optional)
///
...
///  @param limit Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50) (optional)
///
///  @param dataInicio Data de in\u00EDcio da consulta do extrato no formato yyyy-MM-dd (Par\u00E2mentro Ignorado se dataFim n\u00E3o for definida). (optional)
///
///  @param dataFim Data fim da consulta do extrato no formato yyyy-MM-dd  (Par\u00E2mentro Ignorado se dataInicio n\u00E3o for definida). (optional)
///
...
///
///  @param dataInicio Data de in\u00EDcio da consulta do extrato no formato yyyy-MM-dd (Ignorado quando o par\u00E2mentro dataVencimento \u00E9 usado). (optional)
///
///  @param dataFim Data fim da consulta do extrato no formato yyyy-MM-dd  (Ignorado quando o par\u00E2mentro dataVencimento \u00E9 usado). (optional)
///
...
///  @param limit Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50) (optional)
///
///  @param idProduto C\u00F3digo de identifica\u00E7\u00E3o do produto ao qual a conta faz parte. (id). (optional)
///
///  @param idOrigemComercial C\u00F3digo de Identifica\u00E7\u00E3o da Origem Comercial (id) que deu origem a Conta. (optional)
///
///  @param idPessoa C\u00F3digo de Identifica\u00E7\u00E3o da Pessoa Titular da Conta (id). (optional)
///
///  @param idStatusConta C\u00F3digo de Identifica\u00E7\u00E3o do status da conta. (optional)
///
...
///
///  @param dataStatusConta Apresenta a data em que o idStatusConta atual fora atribu\u00EDdo para ela. (optional)
///
///  @param dataCadastro Apresenta a data em que o cart\u00E3o foi gerado. (optional)
///
///  @param dataUltimaAlteracaoVencimento Apresenta a data da ultima altera\u00E7\u00E3o de vencimento. (optional)
///
...
///  @param limit Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50) (optional)
///
///  @param idTransferencia C\u00F3digo de identifica\u00E7\u00E3o da transfer\u00EAncia (id). (optional)
///
///  @param idContaOrigem C\u00F3digo de identifica\u00E7\u00E3o da conta em que o valor ser\u00E1 debitado para a transfer\u00EAncia. (id). (optional)
///
///  @param idContaDestino C\u00F3digo de identifica\u00E7\u00E3o da conta em que o valor ser\u00E1 creditado para a transfer\u00EAncia. (id). (optional)
///
///  @param valorTransferencia Valor estabelecido para ser transferido. (optional)
///
///  @param dataTransferencia Data estabelecida para ocorrer a transfer\u00EAncia. (optional)
///
