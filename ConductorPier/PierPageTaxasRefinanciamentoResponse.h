...
@protocol PierPageTaxasRefinanciamentoResponse
@end

@interface PierPageTaxasRefinanciamentoResponse : PierObject


@property(nonatomic) NSArray<PierTaxasRefinanciamentoResponse>* content;
