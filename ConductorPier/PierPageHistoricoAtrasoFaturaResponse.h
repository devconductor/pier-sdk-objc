...
@protocol PierPageHistoricoAtrasoFaturaResponse
@end

@interface PierPageHistoricoAtrasoFaturaResponse : PierObject


@property(nonatomic) NSArray<PierHistoricoAtrasoFaturaResponse>* content;
