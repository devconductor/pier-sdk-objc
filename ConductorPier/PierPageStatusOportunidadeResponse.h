...
@protocol PierPageStatusOportunidadeResponse
@end

@interface PierPageStatusOportunidadeResponse : PierObject


@property(nonatomic) NSArray<PierStatusOportunidadeResponse>* content;
