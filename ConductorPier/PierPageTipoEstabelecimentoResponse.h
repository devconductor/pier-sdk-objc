...
@protocol PierPageTipoEstabelecimentoResponse
@end

@interface PierPageTipoEstabelecimentoResponse : PierObject


@property(nonatomic) NSArray<PierTipoEstabelecimentoResponse>* content;
