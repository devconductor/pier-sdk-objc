...
@protocol PierPageVinculoEstabelecimentoAdquirenteResponse
@end

@interface PierPageVinculoEstabelecimentoAdquirenteResponse : PierObject


@property(nonatomic) NSArray<PierVinculoEstabelecimentoAdquirenteResponse>* content;
