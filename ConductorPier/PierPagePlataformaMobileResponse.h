...
@protocol PierPagePlataformaMobileResponse
@end

@interface PierPagePlataformaMobileResponse : PierObject


@property(nonatomic) NSArray<PierPlataformaMobileResponse>* content;
