...
{
  return [[JSONKeyMapper alloc] initWithDictionary:@{ @"razaoSocial": @"razaoSocial", @"nomeCredor": @"nomeCredor", @"numeroReceitaFederal": @"numeroReceitaFederal", @"inscricaoEstadual": @"inscricaoEstadual", @"contato": @"contato", @"banco": @"banco", @"agencia": @"agencia", @"digitoAgencia": @"digitoAgencia", @"contaCorrente": @"contaCorrente", @"digitoContaCorrente": @"digitoContaCorrente", @"periodicidade": @"periodicidade", @"pagamentoSemanal": @"pagamentoSemanal", @"pagamentoMensal": @"pagamentoMensal", @"pagamentoDecendialPrimeiro": @"pagamentoDecendialPrimeiro", @"pagamentoDecendialSegundo": @"pagamentoDecendialSegundo", @"pagamentoDecendialTerceiro": @"pagamentoDecendialTerceiro", @"pagamentoQuinzenalPrimeiro": @"pagamentoQuinzenalPrimeiro", @"pagamentoQuinzenalSegundo": @"pagamentoQuinzenalSegundo", @"idCredorRAV": @"idCredorRAV", @"percentualRAV": @"percentualRAV", @"recebeRAV": @"recebeRAV", @"percentualMultiplica": @"percentualMultiplica", @"taxaAdm": @"taxaAdm", @"taxaBanco": @"taxaBanco", @"limiteRAV": @"limiteRAV" }];
}
