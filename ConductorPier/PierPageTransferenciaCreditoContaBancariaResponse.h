...
@protocol PierPageTransferenciaCreditoContaBancariaResponse
@end

@interface PierPageTransferenciaCreditoContaBancariaResponse : PierObject


@property(nonatomic) NSArray<PierTransferenciaCreditoContaBancariaListaResponse>* content;
