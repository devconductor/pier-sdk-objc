...
@protocol PierPageControleVencimentoResponse
@end

@interface PierPageControleVencimentoResponse : PierObject


@property(nonatomic) NSArray<PierControleVencimentoResponse>* content;
