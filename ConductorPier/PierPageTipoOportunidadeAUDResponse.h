...
@protocol PierPageTipoOportunidadeAUDResponse
@end

@interface PierPageTipoOportunidadeAUDResponse : PierObject


@property(nonatomic) NSArray<PierTipoOportunidadeAUDResponse>* content;
