...
@protocol PierPageStatusOportunidadeAUDResponse
@end

@interface PierPageStatusOportunidadeAUDResponse : PierObject


@property(nonatomic) NSArray<PierStatusOportunidadeAUDResponse>* content;
