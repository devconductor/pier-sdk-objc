...
@protocol PierPageStatusContestacaoResponse
@end

@interface PierPageStatusContestacaoResponse : PierObject


@property(nonatomic) NSArray<PierStatusContestacaoResponse>* content;
