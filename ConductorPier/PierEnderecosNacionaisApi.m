#import "PierEnderecosNacionaisApi.h"
#import "PierQueryParamCollection.h"
#import "PierEnderecoResponse.h"


@interface PierEnderecosNacionaisApi ()
    @property (readwrite, nonatomic, strong) NSMutableDictionary *defaultHeaders;
@end

@implementation PierEnderecosNacionaisApi

static PierEnderecosNacionaisApi* singletonAPI = nil;
...
+(PierEnderecosNacionaisApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    ...
    if (singletonAPI == nil) {
        singletonAPI = [[PierEnderecosNacionaisApi alloc] init];
