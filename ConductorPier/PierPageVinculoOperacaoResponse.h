...
@protocol PierPageVinculoOperacaoResponse
@end

@interface PierPageVinculoOperacaoResponse : PierObject


@property(nonatomic) NSArray<PierVinculoOperacaoResponse>* content;
