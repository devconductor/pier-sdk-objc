...
@protocol PierPageArquivoAjusteLoteResponse
@end

@interface PierPageArquivoAjusteLoteResponse : PierObject


@property(nonatomic) NSArray<PierArquivoAjusteLoteResponse>* content;
