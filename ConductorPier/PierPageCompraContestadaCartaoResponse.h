...
@protocol PierPageCompraContestadaCartaoResponse
@end

@interface PierPageCompraContestadaCartaoResponse : PierObject


@property(nonatomic) NSArray<PierCompraContestadaCartaoResponse>* content;
