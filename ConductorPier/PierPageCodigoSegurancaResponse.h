...
@protocol PierPageCodigoSegurancaResponse
@end

@interface PierPageCodigoSegurancaResponse : PierObject


@property(nonatomic) NSArray<PierCodigoSegurancaResponse>* content;
