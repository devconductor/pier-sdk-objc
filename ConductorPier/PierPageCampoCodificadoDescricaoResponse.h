...
@protocol PierPageCampoCodificadoDescricaoResponse
@end

@interface PierPageCampoCodificadoDescricaoResponse : PierObject


@property(nonatomic) NSArray<PierCampoCodificadoDescricaoResponse>* content;
