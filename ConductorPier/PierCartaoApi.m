...
///  @param _id C\u00F3digo de Identifica\u00E7\u00E3o do lote de cart\u00F5es (id) 
///
...
///  @param idOrigemComercial C\u00F3digo de Identifica\u00E7\u00E3o da Origem Comercial (id). (optional)
///
///  @param idProduto C\u00F3digo de Identifica\u00E7\u00E3o do Produto (id). (optional)
///
///  @param idTipoCartao C\u00F3digo de Identifica\u00E7\u00E3o do Tipo do Cart\u00E3o (id). (optional)
///
///  @param idImagem C\u00F3digo de Identifica\u00E7\u00E3o da Imagem (id). (optional)
///
///  @param idEndereco C\u00F3digo de Identifica\u00E7\u00E3o do Endere\u00E7o (id). (optional)
///
///  @param quantidadeCartoes N\u00FAmero de cart\u00F5es existentes no Lote. (optional)
///
///  @param identificadorExterno N\u00FAmero de identifica\u00E7\u00E3o externo (utilizado pelo emissor). (optional)
///
///  @returns PierLoteCartoesPrePagosResponse*
///
...
///  @param quantidadeCartoes N\u00FAmero de cart\u00F5es existentes no Lote. (optional)
///
///  @param dataCadastro Data de Cadastro do Lote de Cart\u00F5es N\u00E3o Nominais. (optional)
///
///  @param usuarioCadastro Nome do Usu\u00E1rio que criou o Lote. (optional)
///
...
///  @param limit Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50) (optional)
///
///  @param idStatusCartao C\u00F3digo de Identifica\u00E7\u00E3o do Status do Cart\u00E3o (id). (optional)
///
///  @param idEstagioCartao C\u00F3digo de Identifica\u00E7\u00E3o do Est\u00E1gio de Impress\u00E3o do Cart\u00E3o (id). (optional)
///
///  @param idConta C\u00F3digo de Identifica\u00E7\u00E3o da Conta a qual o cart\u00E3o pertence (id). (optional)
///
///  @param idPessoa C\u00F3digo de Identifica\u00E7\u00E3o da Pessoa a qual o cart\u00E3o pertence (id) (optional)
///
///  @param idProduto C\u00F3digo de Identifica\u00E7\u00E3o do Produto a qual o cart\u00E3o pertence (id). (optional)
///
///  @param tipoPortador Apresenta o tipo do Portador do cart\u00E3o, sendo: ('T': Titular, 'A': Adicional). (optional)
///
///  @param numeroCartao Apresenta o n\u00FAmero do cart\u00E3o. (optional)
///
///  @param nomeImpresso Apresenta o nome impresso no cart\u00E3o. (optional)
///
///  @param dataGeracao Apresenta a data em que o cart\u00E3o foi gerado. (optional)
///
///  @param dataStatusCartao Apresenta a data em que o idStatusCartao atual do cart\u00E3o fora aplicado, quando houver. (optional)
///
///  @param dataEstagioCartao Apresenta a data em que o idEstagioCartao atual do cart\u00E3o fora aplicado, quando houver. (optional)
///
///  @param dataValidade Apresenta a data de validade do cart\u00E3o em formato yyyy-MM, quando houver. (optional)
///
///  @param dataImpressao Apresenta a data em que o cart\u00E3o fora impresso, caso impress\u00E3o em loja, ou a data em que ele fora inclu\u00EDdo no arquivo para impress\u00E3o via gr\u00E1fica. (optional)
///
///  @param arquivoImpressao Apresenta o nome do arquivo onde o cart\u00E3o fora inclu\u00EDdo para impress\u00E3o por uma gr\u00E1fica, quando houver. (optional)
///
///  @param flagImpressaoOrigemComercial Quando ativa, indica que o cart\u00E3o fora impresso na Origem Comercial. (optional)
///
///  @param flagProvisorio Quando ativa, indica que o cart\u00E3o \u00E9 provis\u00F3rio. Ou seja, \u00E9 um cart\u00E3o para uso tempor\u00E1rio quando se deseja permitir que o cliente transacione sem que ele tenha recebido um cart\u00E3o definitivo. (optional)
///
///  @param codigoDesbloqueio Apresenta um c\u00F3digo espec\u00EDfico para ser utilizado como vari\u00E1vel no processo de desbloqueio do cart\u00E3o para emissores que querem usar esta funcionalidade. (optional)
///
///  @param sequencialCartao N\u00FAmero sequencial do cart\u00E3o (optional)
///
